...
import LoadingButton from "./ui/loding-button";
...
export default function AddEditNoteDialog({
  ...
  async function onSubmit(input: CreateNoteSchema) {
    try {
      if (noteToEdit) {
        const reposnse = await fetch("/api/notes", {
          method: "PUT",
        ...
        if (!reposnse.ok) {
          console.error("error updating note", reposnse);
          throw Error("Status Code: " + reposnse.status);
        }
      } else {
